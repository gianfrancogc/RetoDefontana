...
namespace Defontana.Models
{
    public partial class PruebaContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=lab-defontana-202310.caporvnn6sbh.us-east-1.rds.amazonaws.com;Initial Catalog=Prueba;user id=ReadOnly;password=d*3PSf2MmRX9vJtA5sgwSphCVQ26*T53uU;MultipleActiveResultSets=True");
            }
        }
